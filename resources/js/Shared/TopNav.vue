        ...
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                <ul class="nav navbar-nav d-xl-none">
                    <li class="nav-item">
                        <div class="nav-link menu-toggle cursor-pointer" @click="toggleVerticalMenuActive">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <Link href="/panel/profile" class="dropdown-item">
                            <Icon title="user" width="24" height="24"/>
                            Profile
                        </Link>
                        <div class="dropdown-divider"></div>
                        <Link href="/panel/settings" class="dropdown-item">
                            <Icon title="settings" width="24" height="24"/>
                            Settings
                        </Link>
                        <Link href="/logout" method="post" class="dropdown-item w-100" as="button">
                            <Icon title="power" width="24" height="24"/>
                            Log Out
                        </Link>
                    </div>
                </li>
