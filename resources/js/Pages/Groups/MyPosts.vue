        ...
        <div class="container my-5">
            ...
            <div class="card shadow-sm">
                ...
                <div class="position-relative">
                    <img src="https://sb.ecobnb.net/app/uploads/sites/3/2020/01/nature-1170x490.jpg" alt="Cover Photo"
            ...
            <div class="col-md-6 mx-auto">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="d-flex ms-1 justify-content-between mt-1 mb-2">
                        <label for="inputImage" class="form-label bg-light-primary px-4 py-1 rounded-3 text-muted d-flex align-items-center cursor-pointer">
                ...
                <div class="card shadow-sm mt-4 p-2" v-for="blog in blogs?.data">
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        ...
                        <div class="position-relative">
                            <button class="btn btn-danger btn-sm" @click="deleteItemModal(blog?.id)">
                                <vue-feather type="trash-2" size="13" class="text-white"></vue-feather>
                            </button>
                        </div>
                    </div>
